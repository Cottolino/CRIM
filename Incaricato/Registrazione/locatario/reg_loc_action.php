...
<div class="alert alert-success">
    <strong>Success!</strong>Locatario Aggiunto!
  </div>

<div class="jumbotron">
    <h3 class="m-5 d-flex justify-content-center">Inserito Locatario</h3>
    </div>
<?php
...
$sql = "SELECT* FROM locatari WHERE locatario_cod_fiscale=?";
$stmt = $db->prepare($sql);
$stmt->execute([
    $cod_fiscale
]);
...
{
    $sql = "INSERT INTO locatari(locatario_nome, locatario_cognome, locatario_data_nascita, locatario_indirizzo, 
