...
<div class="alert alert-success">
    <strong>Success!</strong>Conduttore Aggiunto!
</div>


<div class="jumbotron">
    <h3 class="m-5 d-flex justify-content-center">Inserito Conduttore</h3>
    </div>
<?php
...
$sql = "SELECT* FROM conduttori WHERE conduttore_cod_fiscale=?";
$stmt = $db->prepare($sql);
$stmt->execute([
    $cod_fiscale
]);
...
{
    $sql = "INSERT INTO conduttori(conduttore_nome, conduttore_cognome, conduttore_data_nascita, conduttore_indirizzo, 
    ...
    if($res==true)
    {
        //echo "<h2>CONDUTTORE inserito</h2>";
        echo "<table class='table'>'";
        echo "<tr><th>Nome</th><th>Cognome</th><th>Data Nascita</th><th>Indrizzo</th><th>Cod.Fiscale</th><th>Email</th><th>Numero</th><th>Documento</th></tr>";
        echo "<tr>";
        echo "<td>".$nome."</td>";
        echo "<td>".$cognome."</td>";
        echo "<td>".$data_nascita."</td>";
        echo "<td>".$indirizzo."</td>";
        echo "<td>".$cod_fiscale."</td>";
        echo "<td>".$email."</td>";
        echo "<td>".$num."</td>";
        echo "<td>".$doc."</td>";
        echo "</tr>";
