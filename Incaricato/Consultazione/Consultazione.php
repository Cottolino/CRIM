...
<form action='consultazione_metodo.php' method='POST' class="form-group">
        ...
        <input type='date' id='data_nascita' name='data_nascita' onchange="mydate1()" placeholder="Data Nascita" class="form-control">
        ...
        <input type='text' id='cod_fiscale' name='cod_fiscale' maxlength="16" placeholder="Codice Fiscale" class="form-control">
        <br>
        <!-- <label for='email'>Email</label> -->
        <input type='text' id='email' name='email' placeholder="Email" class="form-control">
        <br>
        <!-- <label for='num'>Numero Cellulare</label> -->
        <input type='text' id='num' name='num' placeholder="Numero Cellulare" class="form-control">
        <br>
