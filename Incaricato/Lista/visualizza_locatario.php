...
<div class="jumbotron">
    <h3 class="m-5 d-flex justify-content-center">Visualizza Locatario</h3>
    </div>
<?php
...
foreach($stmt->fetchAll(PDO::FETCH_ASSOC) as $row)
{
    ...
    echo "<td>".$row['locatario_data_nascita']."</td>";
    echo "<td>".$row['locatario_indirizzo']."</td>";
    echo "<td>".$row['locatario_cod_fiscale']."</td>";
    echo "<td>".$row['locatario_email']."</td>";
    echo "<td>".$row['locatario_num']."</td>";
    echo "<td><i class='fa-regular fa-image'></i>".$row['locatario_doc']."</td>";
    echo "<td><a class='btn btn-success' href='visualizza_contratti_locatario_by_cod.php?id=".$row['locatario_id']."'>VISUALIZZA CONTRATTI</a></td>";
