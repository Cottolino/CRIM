...
<div class="jumbotron">
    <h3 class="m-5 d-flex justify-content-center">Visualizza Conduttore</h3>
    </div>
    <?php
...
foreach($stmt->fetchAll(PDO::FETCH_ASSOC) as $row)
{
    ...
    echo "<td>".$row['conduttore_cod_fiscale']."</td>";
    echo "<td>".$row['conduttore_data_nascita']."</td>";
    echo "<td>".$row['conduttore_indirizzo']."</td>";
    echo "<td>".$row['conduttore_email']."</td>";
    echo "<td>".$row['conduttore_num']."</td>";
    echo "<td><i class='fa-regular fa-image'></i>".$row['conduttore_doc']."</td>";
    echo "<td><a class='btn btn-success' href='visualizza_contratti_conduttore_dy_cod.php?id=".$row['conduttore_id']."'>VISUALIZZA CONTRATTI</a></td>";
