...
$stato = $_POST['stato_futuro'];
$id = $_POST['id'];

//echo "Stato:".$stato." ID:".$id;
$sql = "UPDATE contratti SET contratto_stato=:stato WHERE contratto_id=:id";
$stmt = $db->prepare($sql);
$res = $stmt->execute([
     "stato" => $stato,
     "id" => $id
 ...
 if($res == true)
 {
   echo "<div class='alert alert-success'>
        <strong>Success!</strong>Stato Aggiornato!
        </div>";
 }
